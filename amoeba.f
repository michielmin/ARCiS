...
14      continue
      ...
      iter=iter+2
      ytry=amotry(p,y,psum,mp,np,ndim,funk,ihi,-1.0d0,ny)
      if (ytry.le.y(ilo)) then
        ytry=amotry(p,y,psum,mp,np,ndim,funk,ihi,2.0d0,ny)
      else if (ytry.ge.y(inhi)) then
        ysave=y(ihi)
        ytry=amotry(p,y,psum,mp,np,ndim,funk,ihi,0.5d0,ny)
...
16        continue
      ...
      goto 2
      END
      FUNCTION amotry(p,y,psum,mp,np,ndim,funk,ihi,fac,ny)
      INTEGER ihi,mp,ndim,np,NMAX,ny
